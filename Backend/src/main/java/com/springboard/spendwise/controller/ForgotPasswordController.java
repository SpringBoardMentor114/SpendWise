package com.spendwise.demo.controller;

import com.spendwise.demo.entity.Mail;
import com.spendwise.demo.entity.PasswordForgot;
import com.spendwise.demo.entity.PasswordResetToken;
import com.spendwise.demo.entity.User;
import com.spendwise.demo.service.framework.EmailService;
import com.spendwise.demo.service.framework.PasswordResetTokenService;
import com.spendwise.demo.service.framework.UserService;
...
public class ForgotPasswordController {
    ...
    public String processPasswordForgot(@Valid @ModelAttribute("passwordForgot") PasswordForgot passwordForgot,
        ...
        Mail mail = new Mail();
        mail.setFrom("no-reply@spendwise.com");
        ...
        mailModel.put("signature", "http://spendwise.com");
